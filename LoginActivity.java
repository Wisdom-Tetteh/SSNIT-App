...
public class LoginActivity extends AppCompatActivity {
            ...
            mAuth.signInWithEmailAndPassword(email, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful())
                    {
                        ...
                        Toast.makeText(LoginActivity.this, "Wrong Username 0r Password!... Try Again or SignUp", Toast.LENGTH_SHORT).show();
                    }
                }
            });
    ...
    public void signupLogButtonClicked (View view){
        Intent signupLogButtonClicked = new Intent(LoginActivity.this, Register.class);
        startActivity(signupLogButtonClicked);
    }
